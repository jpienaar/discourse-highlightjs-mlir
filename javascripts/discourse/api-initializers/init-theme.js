...
api.registerHighlightJSLanguage("mlir",function(){"use strict";return function(e){
...
begin:"#"+s}]},e.C_NUMBER_MODE]}}}());}); sed -e s/hljs.registerLanguage/api.registerHighlightJSLanguage/ ../dist/mlir.min.js
